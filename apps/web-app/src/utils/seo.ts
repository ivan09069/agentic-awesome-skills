...
const FAQ_ITEMS = [
  {
    ...
    answer:
      'Agentic Awesome Skills is an installable GitHub library of 1,525+ reusable SKILL.md playbooks for AI coding assistants. It supports Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and related hosts through direct skill installs, specialized plugins, bundles, workflows, and a searchable catalog.',
  },
  {
...
export function buildHomeMeta(skillCount: number): SeoMeta {
  ...
  const title = visibleCount > 0
    ? `Agentic Awesome Skills | ${visibleCountLabel} AI coding skills and plugins`
    : 'Agentic Awesome Skills | AI coding skills and plugins';
