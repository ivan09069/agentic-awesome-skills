    ...
    def test_sync_curated_docs_updates_counts_and_versions(self):
        ...
        with tempfile.TemporaryDirectory() as temp_dir:
            ...
            (root / "README.md").write_text(
                """# 🌌 Agentic Awesome Skills: 1,304+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More
...
**Agentic Awesome Skills** (Release 8.3.0) is a large, installable skill library for AI coding assistants. It packages 1,273+ reusable `SKILL.md` playbooks, specialized plugins, bundles, workflows, generated catalogs, and a CLI installer so Claude Code, Codex CLI, Cursor, Gemini CLI, Antigravity, and similar tools can reuse proven operating instructions instead of one-off prompts.
""",
                encoding="utf-8",
            )
